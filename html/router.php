...
header("Content-Security-Policy: default-src 'none'; style-src 'self' 'sha256-faU7yAF8NxuMTNEwVmBz+VcYeIoBQ2EMHW3WaVxCvnk='; script-src 'self'; img-src 'self' data:; form-action 'self'; frame-ancestors 'none'; upgrade-insecure-requests;");
